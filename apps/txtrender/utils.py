...
def render_html(input_html,
                ...
                allow_extra=False,
                allow_iframe=False):
    # FIXME Replace usage of this by render_document()
    content_html, content_text, extra_dict = render_document(input_html,
                                                             allow_titles=allow_advanced_format,
                                                             allow_code_blocks=allow_advanced_format,
                                                             allow_alerts_box=allow_advanced_format,
                                                             allow_text_formating=True,
                                                             allow_text_extra=allow_advanced_format,
                                                             allow_text_alignments=allow_advanced_format,
                                                             allow_text_directions=allow_bidir_format,
                                                             allow_text_modifiers=allow_advanced_format,
                                                             allow_text_colors=allow_advanced_format,
                                                             allow_spoilers=allow_advanced_format,
                                                             allow_figures=allow_figures,
                                                             allow_lists=allow_lists,
                                                             allow_todo_lists=allow_lists,
                                                             allow_definition_lists=allow_lists,
                                                             allow_tables=allow_tables,
                                                             allow_quotes=allow_quotes,
                                                             allow_footnotes=allow_advanced_format,
                                                             allow_acronyms=allow_advanced_format,
                                                             allow_links=allow_links,
                                                             allow_medias=allow_images,
                                                             allow_cdm_extra=allow_extra,
                                                             force_nofollow=force_nofollow,
                                                             preview_mode=False,
                                                             hard_newline=False,
